...
if page == "Home":
    ...
    with st.container():
        ...
        st.subheader("We work hard to hlep you become a better you with BRIGHTER FUTURE!!")
        st.write(
        """Our company’s vision - To provide affordable quality education, equipping students with knowledge and skills in their chosen stream.	 
